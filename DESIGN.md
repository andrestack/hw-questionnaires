# Design Guidelines — Hinterland Web

*Brand design system extracted from hinterlandweb.com — May 2026*
...
- Container max-widths: follow Tailwind's `max-w-*` utilities
...
- Focus rings: use Tailwind's `focus-visible:ring-2 focus-visible:ring-primary`
- Respect `prefers-reduced-motion` for blob animations and transitions
...
- **Sizing:** Use Tailwind size utilities (`size-4`, `size-5`, `size-6`) — match to text size
